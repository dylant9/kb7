...
#define KB7_HOST_CAP_SCREEN_STORE KB7_BIT(0)
#define KB7_HOST_CAP_PROFILE_STORE KB7_BIT(1)
#define KB7_HOST_CAP_RUNTIME_SCREEN_SELECT KB7_BIT(2)
#define KB7_HOST_CAP_GAMEPAD KB7_BIT(3)
#define KB7_HOST_CAP_HALL_TELEMETRY KB7_BIT(4)

enum kb7_host_store { KB7_HOST_STORE_SCREEN = 0, KB7_HOST_STORE_PROFILE = 1 };
