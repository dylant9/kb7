...
def validate_loader_reentry(evidence: dict[str, object]) -> None:
    ...
    require(campaign["usb_read_reliability_incident_2026_08_31"] == {
        ...
        "fixed_read_reliability_hardware_run_completed": True,
        "fixed_read_reliability_hardware_runs": 2,
        "fixed_read_reliability_external_programmer_attached_during_runs": False,
        "fixed_read_reliability_run1_nor_lead_stub_length_mm": 300,
        "fixed_read_reliability_run1_wrong_passes": 14,
        "fixed_read_reliability_run1_exact_observations": 386,
        "fixed_read_reliability_run1_exit_status": 1,
        "fixed_read_reliability_run1_wrong_read_classes": {
            "whole_command_zero": 7,
            "whole_command_half_address": 3,
            "whole_command_ff": 1,
            "one_block_late": 1,
            "unclassified": 2,
        },
        "fixed_read_reliability_run2_nor_lead_stub_length_mm": 20,
        "fixed_read_reliability_run2_wrong_passes": 0,
        "fixed_read_reliability_run2_exact_observations": 400,
        "fixed_read_reliability_run2_exit_status": 0,
        "fixed_read_reliability_gate_passed": True,
        "fixed_read_reliability_root_cause":
            "unterminated_nor_spi_lead_stubs_at_soc_xip_clock",
        "loader_f6_05_read_path_statically_traced": True,
...
def validate_region1_campaign(evidence: dict[str, object]) -> None:
    ...
    require(
        ...
        campaign["campaign_tool"] ==
        "tools/flash-access/kb7-region1-reentry-campaign.py" and
        campaign["executor_tool"] ==
        "tools/flash-access/kb7-loader-reentry-executor.py" and
        campaign["campaign_format"] ==
        "KB7 V1.22 fixed region-1 loader-reentry proof campaign v1" and
        campaign["journal_schema"] == "kb7-loader-reentry-proof-journal-v2" and
        campaign["expected_baseline_sha256"] ==
        "2b1472f47e957c6d6cd9e47911f454fabf50c5d6988d90884b5d6193d61fe02f" and
        campaign["proof_core1_raw"] == {
            "entry": "0x1004a525",
            "length": 404,
            "sha256":
                "e753380b3c0ce9fb28f69f4d9d066d0877cbd612dedd37149290556420d29356",
            "build_target": "region1-reentry-proof",
        },
        "region-1 patch campaign identity changed")
    require(campaign["stable_proof_target"] == {
        "core0": "exact stock V1.22 Core0",
        "core1": ("exact stock V1.22 Core1 except one patched sector at the "
                  "application entry"),
        "header_loader_manifest": "exact stock V1.22",
        "proof_full_sha256":
            "f5ff8321e073f7453fc5e070717dbc2c3f01d94748ef752288aeb81f248fade4",
        "core1_target_sha256":
            "472091e04425b49610f70b64d9327fb70ddfdc336b54e4f0a4c597e937bb6fc2",
        "patch_sector_sha256":
            "e1695fbcb0100cc50c56701f2a0b1666a0ebd13c823ff3a941ee90a217faf296",
        "patch_offset": "0x0004a524",
        "patch_length": 404,
        "fixup_offset": "0x0004a6b8",
        "gate_offset": "0x0004a6bc",
        "restore_gate_offset": "0x0004a000",
    }, "region-1 patch stable target changed")
    require(campaign["mutation_domain"] == {
        "core1_patch_sector": "0x0006b000",
        "temporary_core1_poison_sector": "0x00022000",
        "core0_operation_count": 0,
        "header_loader_manifest_operation_count": 0,
        "all_flash_after_core1_operation_count": 0,
    }, "region-1 patch mutation domain changed")
    safety = campaign["safety_model"]
    require(all(safety[key] is True for key in (
        "core1_poisoned_before_any_erase",
        "patch_sector_rebuilt_with_gate_erased",
        "poison_sector_restored_exact_before_gate",
        "every_byte_prefix_state_checksum_evaluated",
        "region0_checksum_valid_at_every_boundary",
        "one_operation_per_cli_invocation",
        "durable_terminal_intent_before_backend_or_usb",
        "two_exact_full_chip_reads_before_and_after_each_mutation",
        "strict_close_before_authorizing_publication",
    )) and safety["final_gate_rank"] == 32 and
        safety["automatic_retry"] is False,
    ...
    require(
        ...
        authorization["generic_firmware_executor_mutation_enabled"] is False and
        authorization["flash_approved"] is False,
        "region-1 patch campaign authorization changed")
    offline = campaign["offline_validation"]
    require(offline == {
        "exact_campaign_operation_count": 40,
        "install_operation_count": 20,
        "restore_operation_count": 20,
        "program_operation_count": 36,
        "erase_operation_count": 4,
        "core0_operation_count": 0,
        "preserved_boot_region_operation_count": 0,
        "command_boundaries_checked": 41,
        "modeled_byte_prefix_states_checked": 34856,
        "distinct_prefix_states_evaluated": 32470,
        "single_bit_poison_prefix_states_checked": 1026,
        "sparse_gate_subset_proofs": 2,
        "early_loader_valid_non_target_states": 0,
        "install_then_restore_exact_full_baseline": True,
    }, "region-1 patch offline validation changed")
    require(campaign["hardware_validation"] == {
        "runs": 1,
        ...
        "read_only_preflight_2026_09_05_usb_address": 4,
        "read_only_preflight_2026_09_05_observed_full_sha256":
            "35968ec55f16c64fcdca72a6c39edb9b563e5e466657dce67827dc63149566fa",
        "read_only_preflight_2026_09_05_live_region_sha256":
            "04b21e7889e26171b3d2b338554672faa3f86a40e550d566a89f2eafa67d70b4",
        "read_only_preflight_2026_09_05_live_region_unchanged_since_2026_09_03": True,
        "read_only_preflight_2026_09_05_program_or_erase_commands": 0,
        "campaign_run_2026_09_06_revision": "region1-reentry-mutation-enabled",
        "campaign_run_2026_09_06_executor_source_sha256":
            "ba487415d24a0af4cdbf05116ba3592a890a3f1005eaabae34d503aee3477632",
        "campaign_run_2026_09_06_preflight_exit_status": 0,
        "campaign_run_2026_09_06_preflight_usb_address": 7,
        "campaign_run_2026_09_06_install_steps_exit_zero": 20,
        "campaign_run_2026_09_06_first_programmed_block_program_behaved_as_page_program": True,
        "campaign_run_2026_09_06_journal_terminal_status": "proof_installed",
        "campaign_run_2026_09_06_journal_terminal_boundary": 20,
        "campaign_run_2026_09_06_last_observed_sha256":
            "f5ff8321e073f7453fc5e070717dbc2c3f01d94748ef752288aeb81f248fade4",
        "campaign_run_2026_09_06_proof_boot_attempts": 2,
        "campaign_run_2026_09_06_proof_boot_enumerated": False,
        "campaign_run_2026_09_06_mode_switch_or_usb_command_after_boot": 0,
        "campaign_run_2026_09_06_restore_direction_run": False,
        "campaign_run_2026_09_06_recovery":
            "pending external SPI restore or SWD diagnosis",
        "campaign_run_2026_09_06_leading_cause":
            "proof reset at region 0's 198 MHz boot clock; stock switches to "
            "162 MHz through region 0's IRQ-63 clock service before its own "
            "re-entry",
        "proof_boot_observed": False,
    }, "region-1 patch hardware validation changed")
...
def main() -> int:
    try:
        ...
        validate_region1_campaign(load("kb7-stock-loader-reentry.json"))
